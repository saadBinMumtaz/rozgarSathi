...
import { generateShareToken, getSharedReport, getInterviewSummary } from '../controllers/report.controller.js';
...
// POST /api/reports/interview-summary — authenticated; generates interview summary
router.post('/interview-summary', authMiddleware, getInterviewSummary);
